...
VALUES (
  'payumoney_config',
  '{"merchantKey": "your_payumoney_merchant_key", 
    "merchantSalt": "your_payumoney_merchant_salt", 
    "mode": "test"}'::jsonb,
...
```bash
psql postgresql://bizverse_user:bizverse_secure_password_2024@localhost:5432/bizverse_db \
...
PAYUMONEY_MERCHANT_KEY=your_payumoney_merchant_key
PAYUMONEY_MERCHANT_SALT=your_payumoney_merchant_salt
